...
abstract class NotificationRepository {
  ...
  Future<Either<Failure, NotificationEntity?>> getNotification(String notificationId);
  ...
  Future<Either<Failure, void>> subscribeToTopic(String deviceToken, String topic);

  Future<Either<Failure, void>> unsubscribeFromTopic(String deviceToken, String topic);
  ...
  Future<Either<Failure, List<TopicSubscription>>> getDeviceSubscriptions(String deviceId);

  Future<Either<Failure, List<DeviceEntity>>> getTopicSubscribers(String topicId);
  ...
  Future<Either<Failure, Map<String, dynamic>>> getNotificationSettings(String deviceId);

  Future<Either<Failure, List<NotificationTemplate>>> getNotificationTemplates();
